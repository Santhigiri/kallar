...
function Sidebar({
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Panchangam navigation menu</SheetDescription>
          </SheetHeader>
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Spacer that reserves layout space for the fixed sidebar. Stays at
          icon width even when expanded — the expanded sidebar overlays the
          page instead of pushing it, so fixed-position chrome elsewhere
          (TopAppBar) can offset by a constant instead of tracking state. */}
      <div
      ...
      >
        <div
          ...
          className="flex h-full w-full flex-col bg-sidebar text-sidebar-foreground group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
...
function SidebarMenuButton({
  ...
  // asChild callers (e.g. TanStack Router's <Link>) receive the same
  // className/data attributes directly rather than through a Fragment,
  // since Fragment can't carry props.
